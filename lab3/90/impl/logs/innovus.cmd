...
#  Created on Sat Jun 22 03:19:21 2024                
#                                                     
#######################################################
...
floorPlan -site CoreSite -r 1.4 0.9 20.0 20.0 20.0 20.0
setPinConstraint -corner_to_pin_distance 10
setPinConstraint -pin * -spacing 110 -layer {Metal4 Metal5}
assignIoPins -pin *
...
verify_drc -limit 1000000
verifyConnectivity -type all
zoomBox 56.69350 421.46750 -18.27750 470.36200
report_power
report_area
report_timing
summaryReport

...
// Memory sizes
`define RAMSIZE         1024      // Size (in bytes) of RAM (128kB)
`define RAMMASK         32'h0000_03FF  // Mask used in address mapping
`define RAMCASE         32'h0000_0000
`define AESCASE         32'h0100_0000
`define INTCASE         32'h0200_0000 // Imporvised Interrupt Controller
`define CASEMASK	32'hFF00_0000
`define ROMSIZE         1024       // Size (in bytes) of ROM
